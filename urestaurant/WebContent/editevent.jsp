...
<%if(request.getSession(false).getAttribute("userid") != request.getAttribute("userID")) {%>
...
<body>
	...
	<div class="container main-content">
		<h1>
			<fmt:message key="editEvent" /><!-- Label -->
		</h1>
		<form id="event-frm" action="EditEventServlet" method="post" enctype="multipart/form-data">
			<div class="form-group">
				<label>
					<fmt:message key="eventName" /><!-- Label -->
				</label> 
				<input id="evt-name" name="name" type="text" class="form-control"  value="<%=(request.getAttribute("name"))%>" data-toggle="popover" data-placement="top" data-trigger="focus" />
			</div>
			...
			<div class="form-group">
				...
				<input id="evt-location" name="location" type="text" class="form-control" value="<%=(request.getAttribute("location"))%>" data-toggle="popover" data-placement="top" data-trigger="focus" />
			</div>
			...
			<div class="row form-group">
				<div class="col-xs-12 col-sm-6 col-md-3 col-lg-3">
				    ...
				    <input id="evt-startdate" name="startdate" type="text" class="form-control date" data-toggle="popover" value="<%=(request.getAttribute("startDate"))%>" data-placement="top" data-trigger="focus" />
				</div>
				<div class="col-xs-12 col-sm-6 col-md-3 col-lg-3">
					<label>
						<fmt:message key="time" /><!-- Label -->
					</label> 
					<input id="evt-starttime" name="starttime" type="text" class="form-control time" data-toggle="popover" value="<%=(request.getAttribute("startTime"))%>" data-placement="top" data-trigger="focus" />
				</div>
				<div class="col-xs-12 col-sm-6 col-md-3 col-lg-3">
				    <label>
						<fmt:message key="ends" /><!-- Label -->
					</label> 
				    <input id="evt-enddate" name="enddate" type='text' class="form-control date" data-toggle="popover" data-placement="top" value="<%=(request.getAttribute("endDate"))%>" data-trigger="focus" />
				</div>
				<div class="col-xs-12 col-sm-6 col-md-3 col-lg-3">
					<label>
						<fmt:message key="time" /><!-- Label -->
					</label> 
					<input id="evt-endtime" name="endtime" type="text" class="form-control time" data-toggle="popover" data-placement="top" value="<%=(request.getAttribute("endTime"))%>" data-trigger="focus" />
				</div>
			</div>
			...
			<div class="form-group">
				...
				<textarea id="evt-description" name="description" class="form-control" rows="3" placeholder="Enter an event description..." data-toggle="popover" data-placement="top" data-trigger="focus"><%=(request.getAttribute("description"))%></textarea>
			</div>
	...
	<script>
		...
		$("#event-frm").submit(function(event) {
			...
			$.ajax({
				...
				console.log(data);
				alert("16 Oops! Sorry we cannot process the request at this time.");
			});
		});
	</script>
	 <script>
